...
import { Search, User, Mail, Phone } from 'lucide-vue-next'
...
const updateStatusMutation = useMutation({
  mutationFn: ({ appId, status }: { appId: string; status: ApplicationStatus }) => 
    applicationsApi.updateStatus(appId, status, authStore.user!.fullName, 'manager'),
  onSuccess: () => {
...
<template>
  <div class="p-6">
    <div class="mb-6">
      ...
      <p class="text-muted-foreground">Review and manage job applications</p>
    </div>
